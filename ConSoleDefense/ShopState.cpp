...
void ShopState::UnitUpgrade()
{
		...
		GameMng::Getles()->player.upg[1])
	{
		...
		GameMng::Getles()->player.upg[1] += 200; // 가격증가
		...
		GameMng::Getles()->player.upg[2])
	{
		...
		GameMng::Getles()->player.upg[2] +=300; // 가격증가
		...
		GameMng::Getles()->player.upg[3])
	{
		...
		GameMng::Getles()->player.upg[3] +=600; // 가격증가
		...
		GameMng::Getles()->player.upg[4])
	{
		...
		GameMng::Getles()->player.upg[4] +=1000; // 가격증가
		...
		GameMng::Getles()->player.upg[5])
	{
		...
		GameMng::Getles()->player.upg[5] +=2000; // 가격증가
		...
		GameMng::Getles()->player.upg[6])
	{
		...
		GameMng::Getles()->player.upg[6] +=3000; // 가격증가
		...
		GameMng::Getles()->player.upg[7])
	{
		...
		GameMng::Getles()->player.upg[7] +=5000; // 가격증가
		...
		GameMng::Getles()->player.upg[8])
	{
		...
		GameMng::Getles()->player.upg[8] +=7000; // 가격증가
		...
		GameMng::Getles()->player.upg[9])
	{
		...
		GameMng::Getles()->player.upg[9] +=10000; // 가격증가
		...
		GameMng::Getles()->player.upg[0])
	{
		...
		GameMng::Getles()->player.upg[0] +=22000; // 가격증가
